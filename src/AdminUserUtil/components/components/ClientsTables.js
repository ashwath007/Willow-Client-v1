...
import { assignClientToAdminHere, getAllAdmins, getAllClientAssignedAdmins } from "../../../apis/Admins/manage";
...
export const TransactionsTable = () => {
  ...
  const unassignClientForAdmin = (e, client_id) => {
    ...
    .then(res => {
        ...
        console.log("All Assigned - ",res.data);
        ...
        {/* <td>
          ...
          <Dropdown as={ButtonGroup}>
            ...
            <Dropdown.Menu>
              ...
              <Dropdown.Item onClick={(e) => assignClientForAdmin(e,client_id) }>
                <FontAwesomeIcon icon={faEye} className="me-2" /> Assign For me
              </Dropdown.Item>
              <Dropdown.Item>
                <FontAwesomeIcon onClick={(e) => unassignClientForAdmin(e,client_id) } icon={faTrashAlt} className="me-2" /> UnAssign For me
              </Dropdown.Item>
  ...
  return (
    <Card border="light" className="table-wrapper table-responsive shadow-sm" style={{margin:10}}>
