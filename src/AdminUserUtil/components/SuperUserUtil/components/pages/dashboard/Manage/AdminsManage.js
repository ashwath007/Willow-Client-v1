...
function AdminsManage() {
    ...
    const submitCreateAdmin = (e) => {
      ...
      createAdmin(admin_profile).then(res => { 
          console.log("Res ", res) 
            if(res.data.error){
      ...
      <Container className="px-0">
        <Row className="d-flex flex-wrap flex-md-nowrap align-items-center py-4">
          <Col className="d-block mb-4 mb-md-0">
            ...
            <p className="mb-0">
              Here you can create Admin Profile, and manage the profile.
            </p>
          </Col>
        </Row>
...
<Form.Control  onChange={(e) => setpassword(e.target.value)} type="email" placeholder="************" />
  ...
  <Form.Group className="mb-3">
    <Form.Label>Admin Role & Description</Form.Label>
